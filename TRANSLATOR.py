...
title_label = Label(root, text = "LANGUAGE TRANSLATOR", bg='slate gray',font=("Sylfaen",18,"bold","italic"))
title_label.place(relx=0.5,rely=0.1, anchor=CENTER)


input_label = Label(root,text ="Enter Text", font = 'arial 13 bold', bg ='slate gray')
...
output_label = Label(root,text ="Output", font = 'arial 13 bold', bg ='slate gray')
...
footer_label = Label(root,text ="Shivvesh", font = 'arial 10 italic', bg ='slate gray')
